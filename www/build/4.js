...
var SellLocalProductDashboardPage = (function () {
    ...
    SellLocalProductDashboardPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sell-local-product-dashboard',template:/*ion-inline-start:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-local-product-dashboard/sell-local-product-dashboard.html"*/'<!--\n  Generated template for the SellLocalProductDashboardPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>sellLocalProductDashboard</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  <button ion-button class="input-round"  (click)="createProducts()">เพิ่มรายการสินค้า</button>\n  รายการสินค้า\n  ชื่อสินค้า ราคาต่อหน่วย updateวันที่ แก้ไข ลบ\n</ion-content>\n'/*ion-inline-end:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-local-product-dashboard/sell-local-product-dashboard.html"*/,
        }),
