...
var BuyLocalproductsResultPage = (function () {
    ...
    BuyLocalproductsResultPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-buy-localproducts-result',template:/*ion-inline-start:"/Users/piraan/Desktop/Desktop - Piraan’s MacBook Air/trash/trash/src/pages/buy-localproducts-result/buy-localproducts-result.html"*/'<ion-header>\n  <ion-navbar [hideBackButton]="true">\n   \n    <ion-title>\n      ผลการซื้อสินค้า\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content padding id="page9">\n\n  <h3 id="page9-heading2" style="color:#27B643;text-align:center; margin-top:20%">\n    ทำการซื้อสินค้าเรียบร้อย\n  </h3>\n\n  <ion-grid style="margin-top:40%">\n    <ion-row>\n      <ion-col col-6>\n        <button id="page9-button8" ion-button color="positive" block on-click="goToLocalProducts()">\n          กลับไปหน้าหลัก\n        </button>\n      </ion-col>\n      <ion-col col-6>\n        <button id="page9-button9" ion-button color="secondary" block on-click="goToBuyLocalProducts()">\n          ซื้อสินค้าอีก\n        </button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n'/*ion-inline-end:"/Users/piraan/Desktop/Desktop - Piraan’s MacBook Air/trash/trash/src/pages/buy-localproducts-result/buy-localproducts-result.html"*/,
        }),
