...
var SellKayaEstimatepriceDetailPage = (function () {
    ...
    SellKayaEstimatepriceDetailPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sell-kaya-estimateprice-detail',template:/*ion-inline-start:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-kaya-estimateprice-detail/sell-kaya-estimateprice-detail.html"*/'<!--\n  Generated template for the SellKayaEstimatepriceDetailPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>sell-kaya-estimateprice-detail</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content>\n\n\n    <ion-searchbar (ionInput)="getItemsRecycleWastes($event)"></ion-searchbar>\n    <ion-list>\n      <button ion-item *ngFor="let item of items">\n        <!--{{ item.name }} -->\n      </button>\n    </ion-list>\n    <ion-item *ngFor="let kaya of kayas">\n        <span item-start>\n            <img src="assets/imgs/logo.png" width="60" height="60">\n        </span>\n          <h2>{{kaya.name}}</h2>\n          <h3>Don\'t Know What To Do!</h3>\n          <p item-end>{{kaya.est_price}}บาท</p>\n      \n    </ion-item>\n</ion-content>\n'/*ion-inline-end:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-kaya-estimateprice-detail/sell-kaya-estimateprice-detail.html"*/,
        }),
