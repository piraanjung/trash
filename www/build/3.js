...
var SellLocalProductCreateProductPage = (function () {
    ...
    SellLocalProductCreateProductPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-sell-local-product-create-product',template:/*ion-inline-start:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-local-product-create-product/sell-local-product-create-product.html"*/'<!--\n  Generated template for the SellLocalProductCreateProductPage page.\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n  Ionic pages and navigation.\n-->\n<ion-header>\n\n  <ion-navbar>\n    <ion-title>sellLocalProductCreateProduct</ion-title>\n  </ion-navbar>\n\n</ion-header>\n\n\n<ion-content padding>\n  ชื่อสินค้า \n  คำอธิบาย\n  ราคาต่อหน่วย\n  หน่วย\n  ถ่ายภาพ\n  <button ion-button class="input-round" click="captureImage()"> ถ่ายภาพ</button>\n\n</ion-content>\n'/*ion-inline-end:"/Users/piraan/Desktop/refuze-app/trash/src/pages/sell-local-product-create-product/sell-local-product-create-product.html"*/,
        }),
